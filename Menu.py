...
Repository.Repository.Connect2DB(Repository)
discountList = Repository.Repository.GetTableElements(Repository,"discountTable")
taxList = Repository.Repository.GetTableElements(Repository,"taxTable")
Repository.Repository.InsertDiscount(Repository,1000000,1.2)
# print(discountList)
# print(taxList)
